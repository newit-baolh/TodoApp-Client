          ...
          >
            ...
            <td className='relative cursor-pointer'>
              ...
              {showSpan && item.id === id.id ? (
                showSpan && item.description !== '' ? (
                  <span
                    className={
                      'absolute top-0 left-52 w-full overflow-auto max-h-48 break-words bg-green-200 inline-block px-2 py-2 border rounded-lg shadow-lg duration-200 text-sm '
                    }
                  >
                    {item.description}
                  </span>
                  ...
                  <span
                    className={
                      'absolute top-0 left-52 w-44 bg-yellow-200 inline-block px-1 py-1 border rounded-lg shadow-lg duration-200 text-sm '
                    }
                  >
                    {t('CONTENT EMPTY')}
                  </span>
