...
function ModalForm(props) {
  ...
  return (
    <>
      <button
        className='bg-blue-500 py-2 px-10 rounded-md text-white hover:bg-blue-400'
        onClick={() => {
          setShowModal(true)
          setInputValues({
            id: '',
            ...
            <div className='relative w-1/2 my-6 mx-auto max-w-3xl text-sm'>
              ...
              >
                ...
                <div className='relative py-3 px-10 flex-auto'>
                  <div className='py-3'>
                    <label className='block text-left pb-2 text-gray-700'>
                      {t('TODO NAME')}
                    </label>
                    <input
                      name='name'
                  ...
                  <div className='py-5 text-left'>
                    ...
                    >
                      <option value='Cần làm'>{t('PENDING')}</option>
                      <option value='Đang làm'>{t('DOING')}</option>
                      <option value='Đã xong'>{t('DONE')}</option>
                    </select>
                  </div>
